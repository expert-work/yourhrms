                    ...
                    if ($leaveType->department_id == $userDepartment->department_id) {
                        ...
                        if ($user) {
                            ...
                            if ($leaveRequest->user->manager_id != null) {
                              $this->sendFirebaseNotification($leaveRequest->user->manager_id, 'leave_approved','', 'New Leave Request', $notify_body);
                                sendDatabaseNotification($leaveRequest->user->manager, $details);
                            }
                            if ($leaveRequest->user->myHr() != null) {
                                $this->sendFirebaseNotification($leaveRequest->user->myHr()->id, 'leave_approved','', 'New Leave Request', $notify_body);
