...
@section('content')
    <div class="new-main-content">
                ...
                <div class="row mt-5 py-5 align-items-center mx-text-md-center">
                    ...
                    <div class="offset-lg-1 col-lg-5 mx-mt-md">
                        <div class="side-content">
                            ...
                            {{-- <h5>Trusted By 200+ Companies</h5> --}}
            ...
            <div class="container">
                ...
                <div class="row py-5 align-items-center mx-text-md-center">
                    <div class="col-lg-5 mx-mb-md">
                        <div class="side-img">
                            <img src="{{ url('public/images/banner-2-1.svg') }}" alt="">
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row py-5 align-items-center mx-text-md-center">
                    ...
                    <div class="offset-lg-1 col-lg-5 mx-mb-md mx-md-order-1">
                        ...
                        <div class="side-img">
                            <img src="{{ url('public/images/banner-3-1.svg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="opposite-bg-gradient-frontend">
            <div class="container">
                ...
                <div class="row py-5 align-items-center mx-text-md-center">
                    <div class="col-lg-5 mx-mb-md">
                        <div class="side-img">
                            <img src="{{ url('public/images/SuccessionPlanning.png') }}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 offset-lg-1">
                        <div class="side-content">
        ...
        {{--  --}}
        @include('frontend.includes.upcoming_feature')
                        ...
                        <div class="clients-slider">
                            <div class="d-flex justify-content-between trusted-company-slider">
                                <div class="client-img">
                                    <a href="">
                                        <img src="{{ url('public/images/Easytrax-Limited-Logo.png') }}" alt="">
                                    </a>
                                </div>
                                <div class="client-img">
                                    <a href="">
                                        <img src="{{ url('public/images/One-Ummah-BD-new.png') }}" alt="">
                                    </a>
                                </div>
                                <div class="client-img">
                                    <a href="">
                                        <img src="{{ url('public/images/SS-International-Travels.jpeg') }}"
                                            alt="">
                                    </a>
                                </div>
                                <div class="client-img">
                                    <a href="">
                                        <img src="{{ url('public/images/Step-Footware.jpeg') }}" alt="">
                                    </a>
                                </div>
                                <div class="client-img">
                                    <a href="">
                                        <img src="{{ url('public/images/Woodhouse-Grill.png') }}" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="card-text mb-5">
                                        <p class="descript">I just loved it. Finally got rid of my old-fashioned style and
                                            life couldn’t be much better after that. 24hourworx gave me the best solution
                                            ever.</p>
                                    </div>
                                    <div class="card-text mb-3">
                                        <p class="designationz">Rashed</p>
