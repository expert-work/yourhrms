                            ...
                            <form id="contact-form " class="contact_form" action="{{ route('storeContact') }}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="lg-device-contact-form">
                                            <select class="nice-select" name="contact_for">
                                                ...
                                                <option value="0" {{ old('contact_for') == 0? 'selected':'' }} selected>Support </option>
                                                <option value="1" {{ old('contact_for') == 1? 'selected':'' }}>Query</option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="error-margin">
                                            <input type="number" name="phone"
                                                   placeholder="Phone No" value="{{ old('phone') }}" autocomplete="off">
                                    ...
                                    <div class="col-md-12 text-center mt-4">
                                        <button class="btn gradient-btn login-panel-btn contact_btn" href="javascript:void(0)">Send Message</button>
                                    </div>
