                        ...
                        <form method="POST" action="{{ route('company.store') }}" class="card"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name">Total Employee <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name">Business Type <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name">Trade Licence Number <span
                                    ...
                                    <div class="col-md-6">
                                        <label for="name" class="cus-label">Country </label>
