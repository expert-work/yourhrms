...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Income Details</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <section class="content">
    ...
    <div class="card">
              ...
              <div class="col-sm-3">
                <div class="info-box bg-light">
                  <div class="info-box-content">
                    <span class="info-box-text text-center text-muted">Income Head</span>
                    <span
      ...
      <div class="text-center mt-5 mb-3">
        <a href="{{ route('income.index') }}" class="btn btn-sm btn-default">{{_translate('Back')}}</a>
      </div>
      <!-- /.card-body -->
    </div>
    <!-- /.card -->
