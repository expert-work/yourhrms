                            ...
                            <div class="card-header p-2">
                                <ul class="nav nav-pills">
                                    ...
                                    <li class="nav-item"><a class="nav-link info-btn" href="#security"
                                                            data-toggle="tab">Security Info</a></li>
                                </ul>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="personal">
                                        <form class="form-horizontal" action="{{ route('admin.profile_update') }}"
                                            ...
                                            <div class="form-group row">
                                                <label for="inputName" class="col-sm-2 col-form-label">Date Of
                                                    Birth</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="number" class="form-control" name="phone" id="phone"
                                                           placeholder="Phone" value="{{ @$data['show']->phone }}" required>
                                                    @if ($errors->has('phone'))
                                    ...
                                    <div class="tab-pane" id="security">
                                        <form class="form-horizontal password_reset_form"  action="{{ route('password.change') }}" method="POST">
                                            ...
                                            <div class="form-group row">
                                                <div class="offset-sm-2 col-sm-10">
                                                    <button type="submit"
                                                            class="btn btn-primary action-btn submit_btn">Submit
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
