                                ...
                                <div class="px-primary py-primary">
                                    <div role="tablist" aria-orientation="vertical"
                                        ...
                                        <a href="{{ route('user.edit.profile',[$data['id'],'official']) }}"
                                           class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('user.edit.profile',[$data['id'],'official']) ? 'active' : '' }}"><span>Official</span>
                                        ...
                                        <a href="{{ route('user.edit.profile',[$data['id'],'personal']) }}"
                                           class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('user.edit.profile',[$data['id'],'personal']) ? 'active' : '' }}"><span>Personal</span>
                                        ...
                                        <a href="{{ route('user.edit.profile',[$data['id'],'financial']) }}"
                                           class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('user.edit.profile',[$data['id'],'financial']) ? 'active' : '' }}"><span>Financial</span>
                                            <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                                           width="24" height="24"
                                                                           viewBox="0 0 24 24" fill="none"
                                                                           stroke="currentColor" stroke-width="2"
                                            ...
                                            <a href="{{ route('user.edit.profile',[$data['id'],'emergency']) }}"
                                                class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('user.edit.profile',[$data['id'],'emergency']) ? 'active' : '' }}"><span>Emergency</span>
                                                <span class="active-icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="2" stroke-linecap="round"
                                            ...
                                            <a href="{{ route('user.edit.profile',[$data['id'],'security']) }}"
                                                class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('user.edit.profile',[$data['id'],'security']) ? 'active' : '' }}"><span>Security</span>
                                                <span class="active-icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="2" stroke-linecap="round"
                                        ...
                                        @if(auth()->user()->is_admin==1)
                                            ...
                                            class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('user.edit.profile',[$data['id'],'company']) ? 'active' : '' }}"><span>Company</span>
                                                <span class="active-icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="2" stroke-linecap="round"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize cus-label">name</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize cus-label">email</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                                <input type="text" class="form-control"
                                                                                       name="email"
                                                                    ...
                                                                    <div class="form-group row {{ !appSuperUser() ?'disabledbutton':'' }}" >
                                                                        <label class="col-sm-3 col-form-label text-capitalize">department</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row {{ !appSuperUser() ?'disabledbutton':'' }}">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">designation</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row {{ !appSuperUser() ?'disabledbutton':'' }}">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">joining
                                                                            date</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row {{ !appSuperUser() ?'disabledbutton':'' }}">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">employee
                                                                            type</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">manager</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">grade</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                    ...
                                                    <form action="{{ route('user.update.profile',[$data['id'],$data['slug']]) }}"
                                                        ...
                                                        <fieldset class="form-group mb-5">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">gender</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                                <select name="gender"
                                                                                        class="form-control">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">phone</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                                <input type="text"
                                                                                       class="form-control"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">date
                                                                            of birth </label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">address</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                                <input type="text" class="form-control"
                                                                                       name="address"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">nationality</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                                <input type="text" class="form-control"
                                                                                       name="nationality"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">nid
                                                                            card number</label>
                                                                        <div class="col-sm-7">
                                                                            <div>
                                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">NID Picture</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">passport</label>
                                                                        <div class="col-sm-7">
                                                                            <div>
                                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">Passport Picture</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                                <div class="custom-image-upload-wrapper">
                                                                                    <div class="image-area d-flex">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">blood
                                                                            group</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">Facebook</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">Linkedin</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">Instagram</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">Profile Picture</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                                <div class="custom-image-upload-wrapper">
                                                                                    <div class="image-area d-flex">
                                                        ...
                                                        <fieldset class="form-group mb-5">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">bank
                                                                            name</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                    ...
                                                    <form action="{{ route('user.update.profile',[$data['id'],$data['slug']]) }}"
                                                        ...
                                                        <fieldset class="form-group mb-5">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">name</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                                <input type="text"
                                                                                       class="form-control"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">mobile
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">relationship</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                                <input type="text"
                                                                                       class="form-control"
                                                    ...
                                                    @if(settings('login_method')=='pin')
                                                        <fieldset>
                                                            <form action="{{ route('updateUserPin') }}" method="post">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="pin" class="col-sm-2 col-form-label">PIN <span class="text-danger">*</span></label>
                                                                    <div class="col-sm-4">
