                                    ...
                                    <div class="px-primary py-primary">
                                        <div role="tablist" aria-orientation="vertical"
                                            ...
                                            <a href="{{ route('staff.profile','official') }}"
                                               class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('staff.profile','official') ? 'active' : '' }}"><span>Official</span>
                                            ...
                                            <a href="{{ route('staff.profile', 'personal') }}"
                                               class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('staff.profile', 'personal') ? 'active' : '' }}"><span>Personal</span>
                                                <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                                               width="24"
                                                                               height="24" viewBox="0 0 24 24"
                                                                               fill="none" stroke="currentColor"
                                            ...
                                            @if(auth()->user()->role_id != 1)
                                                ...
                                                class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('staff.profile', 'financial') ? 'active' : '' }}"><span>Financial</span>
                                                    <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                                                width="24"
                                                                                height="24" viewBox="0 0 24 24"
                                                                                fill="none" stroke="currentColor"
