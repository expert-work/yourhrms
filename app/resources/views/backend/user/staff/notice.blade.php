                ...
                <div class="row align-items-end mb-30 table-filter-data mb-3">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group mb-2">
                            <button type="submit" class="btn btn-primary profile_notice_table_search_form">Submit</button>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <table id="table" class="table card-table table-vcenter datatable mb-0 w-100 profile_notice_table">
                            ...
                            <tr>
                                ...
                                <th>{{_translate('Department') }}</th>
                                <th>{{_translate('Subject') }}</th>
                                <th>{{_translate('Description') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
