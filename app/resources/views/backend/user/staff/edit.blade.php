                                ...
                                <div class="px-primary py-primary">
                                    <div role="tablist" aria-orientation="vertical"
                                        ...
                                        <a href="{{ route('staff.staffProfileEditView','official') }}"
                                           class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('staff.staffProfileEditView','official') ? 'active' : '' }}"><span>Official</span>
                                        ...
                                        <a href="{{ route('staff.staffProfileEditView','personal') }}"
                                           class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('staff.staffProfileEditView','personal') ? 'active' : '' }}"><span>Personal</span>
                                        ...
                                        @if(auth()->user()->is_admin==1)
                                            ...
                                            class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('staff.staffProfileEditView','company') ? 'active' : '' }}"><span>Company</span>
                                                <span class="active-icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="2" stroke-linecap="round"
