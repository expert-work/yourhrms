            ...
            <div class="col-md-12 mx-auto">
                <div class="screen">
                    <div class="screen__content">
                        ...
                        <div class="mb-4">
                            {{-- <p class="login-box-msg cus-login-box-msg">{{ __('Hi There!') }}</p> --}}
                            {{-- <p class="login-box-msg cus-login-box-msg fs-22">{{ __('Sign Up for Your Company') }}</p> --}}
                        </div>
                        <form action="" method="post" id="login" class="__user_signup_form">
                            @csrf
                            <div class="ml-4 pt-5 __logo">
                                {{-- <img src="https://onesttech.com/public/client/images/Group%20-1.png" alt=""> --}}
                                <h2 class="adminpanel-title  mb-0 pl-2 ">Signup</h2>
                            </div>
                            <div class="login pb-0">
                                ...
                                <div class="cus__field login__field">
                                    @if (Session::has('phone'))
                                        ...
                                        {{-- <div class="row __first_step">
                                    <div class="input-group mb-3">
                                        <input type="text" name="phone" class="form-control" placeholder="Employer phone"
                                            id="__phone" value="{{ Session::get('phone') }}">
                                    </div>
                                    <p class="text-danger __phone small-text"></p>
                                </div> --}}
                                    @else
                                    ...
                                    <div class=" __seventh_step" style="color: red">
