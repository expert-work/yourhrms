                                ...
                                <form action="{{ route('sms.store') }}" enctype="multipart/form-data" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-7 mx-auto">
                                                {{-- <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="name">{{ _translate('Receiver Number') }} <span
                                                                class="text-danger">*</span></label>
                                                        <input type="number" name="receiver_number" class="form-control"
                                                            placeholder="{{ _translate('Enter Receiver Number') }}"
                                                            value="{{ old('receiver_number') }}" required>
                                                        @if ($errors->has('receiver_number'))
                                                            <div class="error">{{ $errors->first('receiver_number') }}
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div> --}}
                                            ...
                                            <div class="col-md-7 mx-auto">
                                                <div class="form-group">
                                                    <label for="message" class="cus-label">{{ _trans('common.Message') }}</label>
