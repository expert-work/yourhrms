                ...
                enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label class="col-sm-2 control-label required" for="expense_date">{{_translate('Date')}}</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label required">{{_translate('Select a supplier')}}</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label required" for="type">{{_translate('Payment Type')}}</label>
                            <div class="col-sm-8">
                         ...
                         <div class="form-group">
                            <label class="col-sm-2 control-label required" for="type">{{_translate('Type')}}</label>
                            <div class="col-sm-8">
                                <select name="type" id="income_expense_type" class="form-control" required>
                                    <option value="">---- {{_translate('Select Type')}} ----</option>
                                    <option {{ @$data['edit']->type == 1 ? 'selected' : '' }} value="1">{{_translate('Income')}}</option>
                                    <option {{ @$data['edit']->type == 2 ? 'selected' : '' }} value="2">{{_translate('Expense')}}</option>
                                </select>
                                @if ($errors->has('type'))
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group" id="category">
                            <label class="col-sm-2 control-label required">{{_translate('Category')}}</label>
                            <div class="col-sm-8">
                                <select class="form-control demo-select2-placeholder category-select" name="category_id"
                                    id="category_id" required>
                                    <option value="">---- {{_translate('Select Category')}} ----</option>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label required" for="amount">{{_translate('Amount')}}</label>
                            <div class="col-sm-8">
                                <input type="number" placeholder="{{_translate('Amount')}}" id="amount" name="amount"
                        ...
                        <div class="col-lg-12 card-footer text-right sa-flex">
                            <a href="{{ URL::previous() }}" class="btn btn-danger" type="cancel">{{_translate('Cancel')}}</a>
