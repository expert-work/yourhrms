                        ...
                        <form role="form" action="{{ route('payments.store') }}" method="post" class="require-validation"
                            ...
                            <div class='form-row row'>
                                <div class='col-md-12 error form-group d-none'>
                                    <div class='alert-danger alert'>{{ _trans('common.Please correct the errors and try
                                        again.') }}</div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <button class="btn btn-primary btn-lg btn-block" type="submit">{{ _trans('payment.Pay Now ($100)') }}</button>
                                </div>
                            </div>
