                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" required value="{{ @$data['edit']->name }}">
                                                @if ($errors->has('name'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                @foreach ($data['clients'] as $client)
                                                    <select name="client_id" class="form-control" required >
                                                        <option selected value="{{ @$client->id }}" {{ $data['edit']->client_id == $client->id ? ' selected' : '' }} > {{ @$client->name }}</option>
                                                    </select>
                                                @endforeach
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="range" name="progress" class="form-control" min="0"
                                                    max="100" value="{{ @$data['edit']->progress }}" oninput="progressValue(this.value)"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select name="status" class="form-control select2" required>
                                                    <option value="24" {{ $data['edit']->status_id == 24 ? ' selected' : '' }} >{{ _trans('project.Not Started') }}</option>
                                                    <option value="26" {{ $data['edit']->status_id == 26 ? ' selected' : '' }}>{{ _trans('project.In Progress') }} </option>
                                                    <option value="25" {{ $data['edit']->status_id == 25 ? ' selected' : '' }}>{{ _trans('project.On Hold') }}</option>
                                                    <option value="28" {{ $data['edit']->status_id == 28 ? ' selected' : '' }} >{{ _trans('project.Cancelled') }}</option>
                                                    <option value="27" {{ $data['edit']->status_id == 27 ? ' selected' : '' }} >{{ _trans('project.Completed') }}</option>
                                                </select>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select name="billing_type" class="form-control select2" required
                                                    ...
                                                    <option value="fixed" {{ $data['edit']->billing_type == 'fixed' ? ' selected' : '' }}>{{ _trans('project.Fixed Rate') }}
                                                    </option>
                                                    <option value="hourly" {{ $data['edit']->billing_type == 'hourly' ? ' selected' : '' }}>{{ _trans('project.Project Hours') }}</option>
                                                </select>
                                        ...
                                        <div class="col-lg-6 total_rate {{ $data['edit']->billing_type == 'fixed' ? '' : 'd-none' }}">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-6 per_rate {{ $data['edit']->billing_type == 'fixed' ? 'd-none' : '' }}">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input hidden value="{{ _trans('project.Select Members') }}"
                                                    id="select_members">
                                                <select name="user_ids[]" class="form-control" id="members" required multiple onchange="newMembers()">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="start_date" class="form-control"
                                                    value="{{ @$data['edit']->start_date ? @$data['edit']->start_date :  date('Y-m-d') }}" required>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="end_date" class="form-control"
                                                    value="{{  @$data['edit']->end_date ? @$data['edit']->end_date :  date('Y-m-d') }}" required>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select name="priority" class="form-control select2" required>
                                                    <option value="32" {{ @$data['edit']->priority == 32 ? 'selected' : '' }}>{{ _trans('project.Low') }}</option>
                                                    <option value="31" {{ @$data['edit']->priority == 31 ? 'selected' : '' }}> {{ _trans('project.Medium') }}</option>
                                                    <option value="30" {{ @$data['edit']->priority == 30 ? 'selected' : '' }}>{{ _trans('project.High') }}</option>
                                                    <option value="29" {{ @$data['edit']->priority == 29 ? 'selected' : '' }}>{{ _trans('project.Urgent') }}
                                                    </option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group clearfix">
                                                    <div class="icheck-primary d-inline">
                                                        <input name="notify_all_users" value="1" {{ @$data['edit']->notify_all_users ? 'checked' : '' }} class="checkbox" type="checkbox" id="checkboxSuccess3">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group clearfix">
                                                    <div class="icheck-primary d-inline">
                                                        <input name="notify_all_users_email" value="1"  type="checkbox" id="email_notification" {{ @$data['edit']->notify_all_users_email ? 'checked' : '' }}>
