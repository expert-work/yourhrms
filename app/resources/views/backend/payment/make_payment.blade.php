  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> Create Payment</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card card-primary">
                <!-- form start -->
                      ...
                      <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group">
                                <label>User</label>
                                <select class="form-control" name="payment" data-dropdown-css-class="select2-primary" style="width: 100%;">
                  ...
                  <div class="card-footer">
                    <a href="{{ url('dashboard/payment') }}" class="btn btn-default float-left">Back</a>
