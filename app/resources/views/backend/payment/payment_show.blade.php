...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Payment Show</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item active">Payment Show</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          ...
          <div class="card">
                ...
                <div class="col-12 col-md-12 col-lg-12 order-2 order-md-1">
                  <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-3">
                      <div class="info-box bg-light">
                        <div class="info-box-content">
                          <span class="info-box-text text-center text-muted">Due</span>
                          <span
            ...
            <div class="text-center mt-5 mb-3">
              <a href="{{ url('dashboard/payment') }}" class="btn btn-sm btn-default">{{_translate('Back')}}</a>
            </div>
            <!-- /.card-body -->
          </div>
