...
{{--                                                                    @dd($data)--}}
                                                                    <div class="col-sm-6 invoice_description">
                                                                        <p>
                                                                            <strong>{{ _translate('Issue Name') }} :</strong> {{ @$data['payment']->user->name }}
                                                                        </p>
                                                                    </div>
                                                                    <div
                                                                        class="col-sm-6 invoice_description invoice_right_description pull-right text-right">
                                                                        <p>
                                                                            <strong>Issue Date : </strong> {{ date_format_for_view($data['payment']->created_at) }} <br>
                                                                        </p>
                                                                        <p>
                                                                            <strong>Invoice No : </strong> {{ $data['payment']->invoice_number }} <br>
                                                                        </p>
                                                                    </div>
                                                                ...
                                                                <table
                                                                    ...
                                                                    <thead>
                                                                        <tr style="border-bottom: 1px solid #dee2e6">
                                                                            <th class="text-center" width="85%">Month</th>

                                                                            <th>{{ _trans('common.Action') }}</th>>Amount</th>
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-right">{{ _translate('Sub Total :') }}</td>
                                                                        <td class="text-right">{{ $data['payment']->paid_amount }}৳</td>

                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text-right">{{ _translate('Total Due:') }}</td>
                                                                        <td class="text-right">{{ $data['payment']->due_amount }}৳</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text-right">{{ _translate('Total Paid Amount:') }}</td>
                                                                        <td class="text-right">{{ $data['payment']->paid_amount }}৳</td>
                                                                    </tr>
                                                                    </tbody>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <p class="text-uppercase"> <strong>In
                                                                                Words:</strong>{{ numberTowords($data['payment']->paid_amount) }} Only .</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
