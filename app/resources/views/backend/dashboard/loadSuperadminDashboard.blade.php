            ...
            <div class="row">
                <div class="col-sm-4 col-xl-2 mb-2 mb-xl-0">
                    <div class="media">
                        ...
                        <div class="media-body my-auto">
                            ...
                            <p class="card-text font-small-3 mb-0"> Total Companies </p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 col-xl-2 mb-2 mb-xl-0">
                    <div class="media">
                        ...
                        <div class="media-body my-auto">
                            <h4 class="font-weight-bolder mb-0"> 230k </h4>
                            <p class="card-text font-small-3 mb-0"> Total Income </p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 col-xl-2 mb-2 mb-xl-0">
                ...
                <div class="col-sm-4 col-xl-2 mb-2 mb-xl-0">
                    <div class="media">
                        ...
                        <div class="media-body my-auto">
                            <h4 class="font-weight-bolder mb-0"> 230k </h4>
                            <p class="card-text font-small-3 mb-0"> New Registration</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 col-xl-2 mb-2 mb-xl-0">
                    <div class="media">
                        ...
                        <div class="media-body my-auto">
                            <h4 class="font-weight-bolder mb-0"> 230k </h4>
                            <p class="card-text font-small-3 mb-0"> New Message</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="card-admin">
                        <div class="card-header">
                            ...
                            <h4 class="font-weight-bolder mb-1"> 230k </h4>
                            <div id="barChart">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card-admin-header">
                            <div class="card-body">
                                ...
                                <h4 class="text-center"> $25,852 </h4>
                                <div class="d-flex justify-content-center">
                                    <span class="font-weight-bolder mr-1">Budget:</span>
                                    <span>56,800</span>
                                </div>
                            </div>
                            <div id="dashDotted">
    ...
    <div class="col-lg-4">
        <div class="card user-card">
            <div class="card-title">
                <h4 class="pt-4 pl-3">Recent Users</h4>
            </div>
            <div class="card-body">
                            ...
                            <div class="d-flex user-details">
                                ...
                                <div class="card-user-info ml-4">
                                    ...
                                    <div class="user-timing  d-flex align-items-center">
                                        ...
                                        <p class="ml-2">house 148 road 13b banani</p>
