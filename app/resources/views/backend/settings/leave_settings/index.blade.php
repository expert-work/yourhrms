                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label text-capitalize pt-0 pb-0">Sandwich Leave
                                            ...
                                            <hr>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label text-capitalize pt-0 pb-0">Fiscal Year
                                            ...
                                            <hr>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label text-capitalize pt-0 pb-0">Leave Prorate
                                                ...
                                                <div class="offset-md-4 col-md-4">
                                                    @if(hasPermission('leave_settings_update'))
                                                        <a href="{{ route('leaveSettings.edit') }}"
                                                           class="btn btn-primary pull-right">Edit information</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
