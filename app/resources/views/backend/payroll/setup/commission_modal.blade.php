                    ...
                    <div class="col-md-12">
                        <form action="{{ $data['url'] }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="type">{{ _trans('common.Commission') }}</label>
                                <select name="set_up_id" class="form-control select2" required>
                            ...
                            <div class="form-group">
                                <label for="type">{{ _trans('common.Type') }}</label>
                            ...
                            <div class="form-group">
                                <label for="type">{{ _trans('common.Status') }}</label>
